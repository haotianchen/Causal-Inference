...
> This week's section will be a quick review of probability theory, linear algebra, and OLS. We will refer to several other documents, including the Math Prefresher (online), Basic Matrix Algebra Review (pdf), OLS in Matrix Form (pdf), and Standard Errors in OLS (pdf). For the PDF files, they are easier to view if you download them from the Github repository. 
