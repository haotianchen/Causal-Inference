...
I develop this document based on materials from Soonhong Cho, the previous TA for PS 200C. 

## Regression Discontinuity Design
***

 - Sharp RDD: find a fixed cutoff point $c$ of a running (forcing) variable $X$ which determines the treatment assignment such that $D_i = \mathbf{1}_{\{X_i \geq c\}}$. If $D_i$ is only probabilistically (not **completely**) determined, it's called "fuzzy" RDD. **Hint**: this whole section relates to Pset 4, Q3.
 ...
 - Example 2: How Did Absentee Voting Affect the 2020 U.S. Election? Yoder et al. (2021) 
     ...
     + What is the running variable? What is the treatment? What is the outcome variable? 
